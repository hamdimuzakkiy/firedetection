...
class luminance(c_data,imageProcessing):
    ...
    def toLuminance(self,gaussianLuminance7,gaussianLuminance13):
        ...
        # max7,max13 = c_data.getMaxList(self,gaussianLuminance7),c_data.getMinList(self,gaussianLuminance13)
        # min7,min13 = c_data.getMaxList(self,gaussianLuminance7),c_data.getMinList(self,gaussianLuminance13)

        max7,max13 = np.max(gaussianLuminance7),np.min(gaussianLuminance13)
        min7,min13 = np.max(gaussianLuminance7),np.min(gaussianLuminance13)
